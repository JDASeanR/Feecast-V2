...
const S = StyleSheet.create({
  ...
  headerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#3D3935', borderRadius: 4, padding: '10px 14px', marginBottom: 14 },
  headerLeft: { flexDirection: 'row', alignItems: 'center' },
  logo: { width: 36, height: 36, borderRadius: 4 },
  firmName: { fontSize: 11, fontFamily: 'Helvetica-Bold', letterSpacing: 1, color: '#F5F5F1' },
  firmSub: { fontSize: 8, color: 'rgba(245,245,241,0.5)', letterSpacing: 1, marginTop: 2 },
  headerRight: { alignItems: 'flex-end' },
  headerDate: { fontSize: 8, color: 'rgba(245,245,241,0.45)' },
  headerConfidential: { fontSize: 7, color: 'rgba(245,245,241,0.35)', marginTop: 2, letterSpacing: 0.5 },
                ...
                return (
                  <View key={i} style={S.tableRow}>
                    ...
                    <View style={{ flex: 0.8, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end' }}>
                      <View style={[S.wipBarOuter, { marginRight: 3 }]}>
